...
import { useParams } from "react-router-dom";
import styled from "styled-components";
import { getUserProfile, putUserProfile, deleteUserProfile } from "../apis/auth";
import { useAuth } from "../contexts/AuthContext";
import { isOwner } from "../utils/profile";
import { type UserProfile } from "../types/UserProfile";
...
const ProfilePage: React.FC = () => {
  ...
  const logout = useLogout(); // 훅에서 반환된 함수 받아오기
  ...
  const isProfileOwner = userProfile ? isOwner(userProfile.uid) : false;
